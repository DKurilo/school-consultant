...
const main = async () => {
  ...
  const filePath = process.env.STORAGE === undefined ? resolve(import.meta.dirname, '..', 'packages', 'api-fast-and-dirty', 'storage', fileName, 'users') : resolve(process.env.STORAGE, 'users', fileName);
